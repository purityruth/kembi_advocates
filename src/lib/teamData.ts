...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    title: "Associate",
    position: "Associate",
    description: "Associate specializing in real estate and property law.",
  ...
  },
  {
    ...
    title: "Associate",
    position: "Associate",
    description: "Associate specializing in tax advisory and compliance.",
    bio: "Angela Ndolo is an Associate in the tax practice, bringing over 10 years of experience in tax advisory, compliance, and dispute resolution. She advises clients on complex tax matters, including corporate restructuring, cross-border transactions, and tax audits. Angela is known for her analytical approach and ability to develop tax-efficient structures that align with clients' business objectives.",
    image: "/images/team/angela.webp",
    email: "angela.ndolo@kembigituralaw.com",
