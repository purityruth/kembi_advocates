...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    bio: "Angela Ndolo is an Associate Advocate in the tax practice, bringing over 10 years of experience in tax advisory, compliance, and dispute resolution. She advises clients on complex tax matters, including corporate restructuring, cross-border transactions, and tax audits. Angela is known for her analytical approach and ability to develop tax-efficient structures that align with clients' business objectives.",
...

  {
    ...
    email: "brigid.alusa@kembigituralaw.com",
    phone: "+254 700 000 006",
    education: [
      // Education details not provided in profile - you may want to add these or leave as empty array
    ],
    achievements: [
  ...
  },
  {
    ...
    title: "Associate Advocate",
    position: "Associate Advocate",
    description: "Associate Advocate specializing in commercial litigation, dispute resolution, and mediation.",
    ...
    email: "peter.njoroge@kembigituralaw.com",
  ...
  {
    id: "6",
    slug: "sabrina-naliali",
    fullName: "Sabrina Naliali",
    title: "Associate Advocate",
    position: "Associate Advocate",
    ...
    email: "sabrina.addikah@kembigituralaw.com",
