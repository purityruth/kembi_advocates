...
const Footer = () => {
  return (
    <footer className="bg-primary/90 bg-gradient-to-r from-primary/900 to-accent/40 text-white py-12">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <address className="text-sm text-gray-300 not-italic space-y-2">
            <p>Nairobi, Kenya</p>
            <p>
              <a href="mailto:law@kembi-gituradv.com" className="hover:text-[#d9d9d9] transition-colors">
                law@kembi-gituradv.com
              </a>
            </p>
            <p>
              <a href="tel:(020) 2454323" className="hover:text-[#d9d9d9] transition-colors">
                (020) 2454323
              </a>
              <br />
              <a href="tel:+254711719401" className="hover:text-[#d9d9d9] transition-colors">
                +254 711 719 401
              </a>
              <br />
              <a href="tel:+254788551401" className="hover:text-[#d9d9d9] transition-colors">
                +254 788 551 401
              </a>
            </p>
          </address>
        ...
        <div>
          ...
          <div className="flex space-x-4 mb-6">
            <a
              href="https://www.linkedin.com/company/kembi-gitura-co-advocates/"
              target="_blank"
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61589809890752"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-[#d9d9d9] transition-colors"
              aria-label="Facebook"
